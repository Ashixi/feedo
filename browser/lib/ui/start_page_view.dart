...
class StartPageView extends StatefulWidget {
  final Function(String, bool) onSearchSubmitted;

  const StartPageView({super.key, required this.onSearchSubmitted});
  ...
  Widget build(BuildContext context) {
    ...
    final bgGradient = isDark 
        ? const LinearGradient(
            ...
            colors: [Color(0xFF2B2E33), Color(0xFF1E2024)],
          )
        : LinearGradient(
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          ...
          child: Column(
            ...
            children: [
              ...
              AnimatedContainer(
                ...
                width: _isSearchFocused ? 650 : 600,
                decoration: BoxDecoration(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Padding(
                      ...
                      child: Icon(
                        Icons.search, 
                        size: 26, 
                        color: _isSearchFocused ? Theme.of(context).colorScheme.primary : (isDark ? Colors.grey.shade400 : Colors.grey.shade600)
                      ),
                    ),
              ...
              SizedBox(
                ...
                child: Wrap(
                  ...
                  children: _quickLinks.map((link) => _QuickLinkItem(
                    ...
                    icon: link['icon'],
                    color: link['color'],
                    onTap: () => widget.onSearchSubmitted(link['url'], false),
                    isDark: isDark,
                  )).toList(),
                ),
              ),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black.withOpacity(widget.isDark ? (_isHovered ? 0.4 : 0.2) : (_isHovered ? 0.1 : 0.05)),
                      blurRadius: _isHovered ? 12 : 6,
                      offset: Offset(0, _isHovered ? 6 : 3),
                    )
                  ],
                  border: Border.all(
                    color: widget.isDark ? Colors.white10 : Colors.transparent,
                  ),
                ),
                child: Center(
                  child: Icon(
