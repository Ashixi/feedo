            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: Colors.transparent.withOpacity(0.05), blurRadius: 10, offset: const Offset(0, 4)),
                  ],
                ),
                child: Row(
                  children: [
                    CircleAvatar(
                      ...
                      child: _authorAvatar == null ? Icon(Icons.person, size: 30, color: Colors.blueAccent) : null,
                    ),
                    SizedBox(width: 16),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(_authorName, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                          SizedBox(height: 4),
                          if (_pubkey != null)
                            GestureDetector(
              ...
              const Text('Account', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.white54)),
              SizedBox(height: 8),
                      ...
                      builder: (_) => AlertDialog(
                        ...
                        content: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 16),
                            SelectableText(nsec, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                          ],
                        ),
                        actions: [
                          TextButton(
              ...
              SizedBox(height: 24),
              const Text('Network', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.white54)),
              SizedBox(height: 8),
