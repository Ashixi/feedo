    ...
    if user and user.user_vector:
        ...
        if EXPOSE_VECTOR_API:
            ...
            if peer_addrs:
                ...
                if remote_hash_ids:
                    stmt_remote = select(Post.id).where(Post.hash_id.in_(remote_hash_ids), Post.item_type == 'post')
        ...
        # Optimize random selection to prevent full table scan timeouts (50s hang)
