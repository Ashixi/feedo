...
export declare class SearchModule {
    ...
    private request;
    search(query: string, limit?: number, federated?: boolean, itemType?: string, offset?: number, appId?: string, searchType?: string, imageUrl?: string): Promise<any>;
    ...
    indexImage(hashId: string, metadata?: Record<string, any>, symmetricKey?: string): Promise<any>;
